            ...
            <div className="container">
                <div className="section">
                    ...
                    <p>Во овој проект е интегриран систем за пребарување и преглед на историски и културни објекти.
                        ...
                        вклучувајќи описи, историски контекст, слики и работно време, што ќе ги поддржи во изборот на објекти за посета.
                ...
                <div className="section">
                    ...
                    <p> Интегрираната интерактивна мапа со OpenStreetView функционалност овозможува визуелен преглед на сите културни
                        ...
                        обогатени со контекстуални информации и слики. Системот ги категоризира објектите според тип, вклучувајќи музеи, споменици, цркви,
