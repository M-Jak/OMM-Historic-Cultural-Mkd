...
public class MonumentFilter implements Filter<String> {
     ...
     * Splits the input string by comma and checks if the second part matches "monument".
     * If the second part matches "monument",
     * constructs a new string with the first, second, third, and fourth parts separated by commas.
     * @param input The input string to be processed.
     * @return A string containing specific parts of the input string if the second part is "monument",
